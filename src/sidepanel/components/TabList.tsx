            ...
            <div key={windowId} className="relative">
              ...
              {selectionMode && (
                <div
                  ...
                  onMouseLeave={() => {
                    if (!isWindowPartiallySelected(windowId) && !isWindowFullySelected(windowId)) {
                ...
                >
                  {isWindowCheckboxVisible(windowId) && (
                    ...
                    >
                      {isWindowFullySelected(windowId) && <Check size={12} className="text-white" strokeWidth={3} />}
                      {isWindowPartiallySelected(windowId) && <Minus size={12} className="text-white" strokeWidth={3} />}
                    </div>
                  )}
                </div>
              )}
